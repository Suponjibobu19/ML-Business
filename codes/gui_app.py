...
from main import (
    load_recipient_map,  # Ajout pour s'assurer que les destinataires sont chargés
...
class EmailTestApp:
    def __init__(self, root):
        ...
        # Ensure recipient map is loaded before starting
        try:
            load_recipient_map()
            print("Recipient map loaded successfully.")
        except Exception as e:
            messagebox.showerror("Error", f"Failed to load recipient map: {e}")
